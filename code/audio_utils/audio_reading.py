...
SAMPLING_RATE = 22000
TMP_DIR_PATH = '/home/marvin/US/TFM/code/tmp'
...
if __name__=='__main__':
    ...
    spectogram = create_spectogram_from_tf_samples(samples,sampling_rate=sr)
    #plot_spectrogram(spectogram)
    specshow(np.squeeze(spectogram.numpy()).T,y_axis='fft_note')
    plt.show()
